...
* [jQuery](http://jquery.com/) 1.8 or newer, up to and including 4.x. The slim builds work too. See [known differences between jQuery builds](#known-differences-between-jquery-builds).
