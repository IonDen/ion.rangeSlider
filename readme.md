...
```javascript
{
    ...
    "from_min": null,           // configured from_min option (null if unset)
    "from_max": null,           // configured from_max option (null if unset)
    "to": 90000,                // TO value
    "to_percent": 90,           // TO value in percent
    "to_value": 0,              // TO index in values array (if used)
    "to_min": null,             // configured to_min option (null if unset)
    "to_max": null,             // configured to_max option (null if unset)
